...
function EditListing() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        setFetching(true);
        const [listingRes, catsRes, locsRes] = await Promise.all([
  ...
  const areasForCity = formData.location.city
    ? locations.filter((l) => l.city === formData.location.city).map((l) => l.area)
    : [];
